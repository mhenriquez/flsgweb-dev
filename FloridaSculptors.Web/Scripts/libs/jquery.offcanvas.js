(function ($)
{
    ...
    $.fn.offcanvas = function (options)
    {
        ...
        var settings = $.extend({
            hasSidebarLeft: true,
            hasSidebarRight: true, // was false
            animated: true,
            oldPhones: true,
            enableTouch: false, // was true
            enableKeys: true
        }, options);
        ...
        return this.each(function ()
        {
            ...
            function slide(direction, settings)
            {
                switch (direction)
                {
                    ...
                    case 'shutRight': // close right pane
